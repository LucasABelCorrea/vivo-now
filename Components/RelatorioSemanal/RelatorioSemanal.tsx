      ...
      <div className="relatorio-card">
        ...
        <div className="humor-options-relatorio">
          <div className="humor-item-relatorio">
            <div className="humor-button-relatorio">{React.createElement(Icon)}</div>
            <span className="humor-label-relatorio">{humorLabels[report.feeling - 1]}</span>
          </div>
        </div>
        <label>Dúvidas não sanadas:</label>
        <input type="text" value={report.question} readOnly />
        <label>Eventos de integração:</label>
        <input type="text" value={report.event} readOnly />
        <label>Comentário adicional:</label>
        <input type="text" value={report.comment} readOnly />
        <button className="submit-button" onClick={() => navigate(-1)}>
          Voltar
        </button>
      </div>
